...
[![Build Status](https://travis-ci.org/gabrysbiz/css-splitter-maven-plugin.svg?branch=release%2F2.0.1)](https://travis-ci.org/gabrysbiz/css-splitter-maven-plugin)
